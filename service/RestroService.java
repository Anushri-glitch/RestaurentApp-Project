...
public class RestoService {
    ...
    static {
        restos.add(new RestaurantModelClass("SagarRatna","Prayagraj",1001,"5 star",200));
        restos.add(new RestaurantModelClass("HaldiRam","Prayagraj",1002,"4.3 star",160));
        restos.add(new RestaurantModelClass("City Mall","Kota",1003,"5 star",200));
        restos.add(new RestaurantModelClass("baati chokha","Jaunpur",1004,"3 star",150));
        restos.add(new RestaurantModelClass("Dosa Plaza","Prayagraj",1005,"7 star",350));
    }
